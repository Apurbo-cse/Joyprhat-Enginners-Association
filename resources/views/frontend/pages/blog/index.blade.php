                        ...
                        <div class="row clearfix">
                          @foreach($posts as $post)
                            <div class="image-column col-lg-6 col-md-6 col-sm-12">
                                <div class="image">
                                    <a href="{{route('blog.details', $post->id)}}"><img src="{{$post->image}}" alt="" /></a>
                                </div>
                            </div>
                            <div class="content-box col-lg-6 col-md-6 col-sm-12">
                                <div class="content-inner">
                                    ...
                                    <div class="text">{{ Str::limit(strip_tags($post->description), 170) }}..<a href="{{route('blog.details', $post->slug)}}" class="read-more">Read More </a></div>
                                </div>
                            </div>
                          @endforeach
                        </div>
