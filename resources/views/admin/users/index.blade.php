                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        @foreach( $users as $user)
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a class="btn btn-success d-inline-block" href="{{ route('admin.user.edit',$user->id) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    <a class="btn btn-info d-inline-block" href="{{ route('admin.user.edit',$user->id) }}"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                </td>
                            </tr>
