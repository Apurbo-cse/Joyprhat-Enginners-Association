        ...
        <div class="col-sm-12">
            <div class="page-header-title">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li><a href="{{route('admin.exicutive.index')}}">exicutive List</a></li>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        @foreach( $users as $exicutive)
                            ...
                            <td>{{ $loop->iteration }}</td>
                                ...
                                <td class="d-flex">
                                    <a class="btn btn-success d-inline-block" href="{{ route('admin.exicutive.edit',$exicutive->id) }}"><i class="fa fa-check" aria-hidden="true"></i></a>
